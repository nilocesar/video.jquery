/* ===========================================================
    VIDEO JQUERY v0.1 - Nilo César - 26/10/2015
/* ===========================================================



/* ===========================================================
    VIDEO JQUERY - Nilo César - 26/10/2015
/* =========================================================== */
...
(function ($) {
    ...
    /* ===========================================================
       ...
       ------ CONTROLE API LOCAL OU streaminng-m3u8 --------------
    ...
    private.localInit = function () {
        ...
        $(obj).append('<video width="' + private.settings.width + '" height="' + private.settings.height + '" id="player1"><source type="application/x-mpegURL" src="' + private.settings.path + '" /></video>');

        $('audio,video').mediaelementplayer({
            flashName: urlofdoc("video.jquery.js") + "/skin.swf",
            success: function (player, node) {
                ...
                pauseStatus = false;
                autoPlayInit = false;
                myPlayer.addEventListener('canplay', canplay);
                myPlayer.addEventListener('timeupdate', timeupdate);
                myPlayer.addEventListener('ended', ended);
                //myPlayer.addEventListener('progress', progress);
                //myPlayer.addEventListener('seeked', seeked);
